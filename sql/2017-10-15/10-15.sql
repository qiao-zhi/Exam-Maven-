...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='考试答题保存表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='二级部门表';
...
CREATE TABLE `employee_in` (
  ...
  `trainStatus` int(11) DEFAULT NULL COMMENT '考试通过情况：\n            1：需要进行1级考试\n            2：需要进行2级考试\n            3：需要进行3级考试\n            4：已通过入场培训考试',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='员工考试表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='历史试卷选项表';
...
CREATE TABLE `historybreakrules` (
  ...
  `minusNum` int(11) DEFAULT NULL,
  PRIMARY KEY (`breakId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='历史违章记录表';
...
CREATE TABLE `historyemployeeexam` (
  ...
  `employeeType` varchar(2) DEFAULT NULL,
  PRIMARY KEY (`gradeId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外来员工历史成绩表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='在线考试答题详细信息表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='在线考试基本信息表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='培训资料表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外来单位工程表';
