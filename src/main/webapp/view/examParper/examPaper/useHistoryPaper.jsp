...
<!-- 修改JS，相当于重新添加 -->
<script src="<%=path%>/js/examParper/examPaper/useHistoryPaper.js"></script>
			...
			<div class="container-fluid">
				<div class="panel panel-default">
					...
					<div class="panel-heading">
						<span>试卷管理</span><span>>使用历史试卷</span>
						<ul class="nav navbar-nav navbar-right">
							...
							<li><button id="el_saveModify" type="button"
									class="btn btn-default navbar-btn" style="margin-top: -6px;">使用</button></li>
						</ul>
					</div>
									...
									<tbody>
										...
										<tr>
											...
											<td><input type="text" readonly="readonly" name=""
												...
												value="${exampaper.usetimes }" disabled="disabled"></td>
										</tr>
										<tr>
											<td>试卷描述</td>
										...
										<tr>
											...
											<td><input type="text" class=""
												name="exampaper.employeename" readonly="readonly"
												value="${session.userinfo.username }" /></td>
										</tr>
										<tr>
											<td>创建时间</td>
                ...
                -->
						...
						<div class="el_addEPtiku">
							...
							<div class="panel panel-default">
								...
								<ul class="list-group el_queryQuestions" id="bankQuestions"></ul>
