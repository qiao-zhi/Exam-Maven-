										...
										<div class="col-md-3 el_qlmQuery">
											<div class="input-group" role="toolbar">
												<span class="el_spans">检修状态：</span> <select
													class="selectpicker form-control" name="bigStatus" onchange="changeCountInfo()"
													title="请选择">
											...
											<div class="modal-body">
												...
												<div class="input-group el_modellist" role="toolbar">
													<span class="el_spans">标段名称：</span> <input name="XXXXXX"
														class="form-control el_modelinput clearAdd add_biaoduan"
														style="width: 90%;" /> <a href=javascript:void(0)
														onclick="addBiaoduan()"><span
									...
									<div class="modal-content">
										...
										<form id="modifyHaulForm">
											<div class="modal-body">
												...
												<button type="button" class="btn btn-primary"
													onclick="addOneBiaoduan()">添加标段</button>
												<hr />
												<table class="table table-hover table-bordered">
													<thead>
														<tr>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<form id="query_biaoduan">
										<input type='hidden' name='currentPage' id='currentPage3' /> <input
											type='hidden' name='currentCount' id='currentCount3' /> <input
											type='hidden' name='haulId' id='haulId_biaoduan' />
									</form>
									<div class="modal-body">
										<div>
											<table class="table table-hover table-bordered">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<form id="query_pernum">
										<input type='hidden' name='currentPage' id='currentPage4' /> <input
											type='hidden' name='currentCount' id='currentCount4' /> <input
											type='hidden' name='haulId' id='haulId_pernum' />
									</form>
									<div class="modal-body">
										<div>
											<table class="table table-hover table-bordered">
